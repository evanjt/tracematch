...
pub use sections::{
    ...
    IdentityParams, IdentityPlan, PriorSection, RetireReason, Retirement, ScaleName, SectionConfig,
    SectionEvidenceCache, SectionGeometryChange, SectionMatch, SectionMergedAway, SectionPortion,
    SectionUpdatePolicy, StepOutcome, Tunables, UnifiedDetection, UnifiedIncrementalResult,
