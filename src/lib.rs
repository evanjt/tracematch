...
pub use sections::{
    ...
    SectionMatch, SectionMergedAway, SectionPortion, SectionUpdatePolicy, StepOutcome, Tunables,
    UnifiedDetection, UnifiedIncrementalResult, confirmed_lift_spans, confirmed_lift_spans_tuned,
    detect_sections_unified, detect_sections_unified_dated, detect_sections_unified_explained,
