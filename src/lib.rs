...
pub use sections::{
    ...
    DetectionMode, DetectionPhase, DetectionProgressCallback, FrequentSection, HysteresisParams,
    HysteresisState, IdentityParams, IdentityPlan, PriorSection, RetireReason, Retirement,
    ScaleName, ScalePreset, SectionConfig, SectionEvidenceCache, SectionGeometryChange,
    SectionMatch, SectionMergedAway, SectionPortion, SectionUpdatePolicy, SplitResult, StepOutcome,
    Tunables, UnifiedDetection, UnifiedIncrementalResult, confirmed_lift_spans,
    ...
    find_all_track_portions, find_sections_in_route, lift_spans, lift_spans_tuned, mutual_overlap,
