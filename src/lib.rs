...
pub use sections::{
    ...
    HysteresisState, IdentityParams, IdentityPlan, MultiScaleSectionResult, PotentialSection,
    PriorSection, RetireReason, Retirement, ScaleName, ScalePreset, SectionConfig,
    SectionEvidenceCache, SectionMatch, SectionPortion, SplitResult, StepOutcome, Tunables,
