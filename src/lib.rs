...
pub use sections::{
    ...
    FrequentSection, HysteresisParams, HysteresisState, IdentityParams, IdentityPlan,
    MultiScaleSectionResult, PotentialSection, PriorSection, RetireReason, Retirement, ScaleName,
    ScalePreset, SectionConfig, SectionEvidenceCache, SectionGeometryChange, SectionMatch,
    SectionMergedAway, SectionPortion, SectionUpdatePolicy, SplitResult, StepOutcome, Tunables,
    UnifiedDetection, UnifiedIncrementalResult, confirmed_lift_spans, confirmed_lift_spans_tuned,
    detect_sections, detect_sections_corridor, detect_sections_flow_graph,
    detect_sections_from_tracks, detect_sections_multiscale,
    ...
    detect_sections_unified_incremental_dated, detect_sections_unified_tuned, dissolve_pressure,
    ...
    plan_identity, plan_identity_tuned, recalculate_section_polyline, self_pass_penalty,
    shares_ground, split_section_at_index, split_section_at_point,
};
