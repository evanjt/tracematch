...
pub use sections::{
    ...
    SectionEvidenceCache, SectionGeometryChange, SectionMatch, SectionMergedAway, SectionPortion,
    SectionUpdatePolicy, SplitResult, StepOutcome, Tunables, UnifiedDetection,
